...
## LEDs
set_property -dict {PACKAGE_PIN T28 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[0]}]
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[1]}]
set_property -dict {PACKAGE_PIN U30 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[2]}]
set_property -dict {PACKAGE_PIN U29 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[3]}]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[4]}]
set_property -dict {PACKAGE_PIN V26 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[5]}]
set_property -dict {PACKAGE_PIN W24 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[6]}]
set_property -dict {PACKAGE_PIN W23 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[7]}]
...
create_pblock pblock_dynamic_0
add_cells_to_pblock [get_pblocks pblock_dynamic_0] [get_cells -quiet [list system_i/dynamic_0]]
resize_pblock [get_pblocks pblock_dynamic_0] -add {SLICE_X86Y150:SLICE_X101Y199}
set_property RESET_AFTER_RECONFIG true [get_pblocks pblock_dynamic_0]
set_property SNAPPING_MODE ON [get_pblocks pblock_dynamic_0]
